...
public class SecureStorage extends CordovaPlugin {
    ...
    public boolean execute(String action, CordovaArgs args, final CallbackContext callbackContext)
        ...
        if ("init".equals(action)) {
            ...
            // To check whether the device is matching API 28 or above i.e not longer
            // support for com.android.credentials.UNLOCK
            ...
            // For lower devices than MATCHES_ANDROID_API_28, Init callback context and
            // Dispatch com.android.credentials.UNLOCK
